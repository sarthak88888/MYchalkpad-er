            ...
            {progress.map((row, i) => {
              ...
              return (
                <View key={i} style={[styles.tableRow, i % 2 === 0 && styles.tableRowAlt]}>
                  ...
                  <Text style={styles.tableCell}>{row.terms.UT1 !== null ? `${row.terms.UT1.toFixed(0)}%` : '--'}</Text>
                  <Text style={styles.tableCell}>{row.terms['Half-Yearly'] !== null ? `${row.terms['Half-Yearly'].toFixed(0)}%` : '--'}</Text>
                  <Text style={styles.tableCell}>{row.terms.Annual !== null ? `${row.terms.Annual.toFixed(0)}%` : '--'}</Text>
