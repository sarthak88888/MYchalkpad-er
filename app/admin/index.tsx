...
import {
  ...
  getBiometricEnabled,
  setBiometricEnabled,
  getUserSession, //  FIXED — import directly, no dynamic import needed
} from '@/lib/storage';
import { COLORS } from '@/lib/theme';
import * as LocalAuthentication from 'expo-local-authentication';

//  FIXED — defined inline instead of importing from @/lib/types
type UserRole = 'admin' | 'teacher' | 'parent' | 'accountant' | 'super_admin' | 'principal';
...
export default function LoginScreen() {
  ...
  async function checkBiometricLogin() {
    try {
      ...
      if (result.success) {
        //  FIXED — direct import instead of dynamic import
...
const styles = StyleSheet.create({
  ...
  modalCard: { backgroundColor: '#FFFFFF', borderRadius: 16, padding: 24, width: '100%', maxWidth: 400, elevation: 8, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.2, shadowRadius: 8 },
