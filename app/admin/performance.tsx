  ...
  function renderStars(subject: string, currentRating: number) {
    return (
      <View style={styles.starsRow}>
        {[1, 2, 3, 4, 5].map(star => (
          <TouchableOpacity key={star} onPress={() => updateRating(subject, 'rating', star)} activeOpacity={0.7}>
                ...
                <View style={styles.trendRow}>
                  {TRENDS.map(trend => (
                    ...
                    >
                      ...
                      />
                      <Text style={[styles.trendChipText, { color: r.trend === trend ? '#FFFFFF' : TREND_COLORS[trend] }]}>
