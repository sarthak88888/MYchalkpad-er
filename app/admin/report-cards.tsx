...
export default function ReportCardsScreen() {
  ...
  useEffect(() => { if (selectedStudent) loadReportCard(); }, [selectedStudent]);
      ...
      <ScrollView style={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        {students.length > 0 && (
          <View style={styles.selectorSection}>
            ...
            <TouchableOpacity style={styles.studentSelector} onPress={() => setShowStudentPicker(true)}>
        ...
        {showStudentPicker && (
          <View style={styles.pickerDropdown}>
            {students.map(s => (
              <TouchableOpacity key={s.id} style={styles.pickerItem} onPress={() => { setSelectedStudent(s); setShowStudentPicker(false); }}>
...
const styles = StyleSheet.create({
  ...
  studentSelector: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderWidth: 1, borderColor: COLORS.border, borderRadius: 8, paddingHorizontal: 14, paddingVertical: 12, backgroundColor: '#FFFFFF' },
  ...
  pickerDropdown: { backgroundColor: '#FFFFFF', marginHorizontal: 16, borderRadius: 8, elevation: 4, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 4, marginTop: 4, marginBottom: 8 },
  ...
  overallRow: { flexDirection: 'row', paddingVertical: 16, paddingHorizontal: 16, borderTopWidth: 1, borderTopColor: COLORS.border },
  ...
  shareBtn: { backgroundColor: COLORS.accent, borderRadius: 0, paddingVertical: 14, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8 },
