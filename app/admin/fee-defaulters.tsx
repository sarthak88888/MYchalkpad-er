        ...
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            ...
            try {
              ...
              //  FIXED — removed successCount/failCount, use result.success instead
              const result = await sendSMS(phones, msg);
              Alert.alert('Done', result.success ? `SMS sent to ${phones.length} parents.` : `Failed: ${result.message}`);
            } catch (e) {
