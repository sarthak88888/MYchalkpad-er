...
const styles = StyleSheet.create({
  ...
  statsBanner: { flexDirection: 'row', backgroundColor: COLORS.primary, paddingVertical: 12, paddingHorizontal: 16 },
  statItem: { flex: 1, alignItems: 'center' },
  statVal: { color: '#FFFFFF', fontSize: 18, fontWeight: 'bold' },
  statLbl: { color: 'rgba(255,255,255,0.7)', fontSize: 11, marginTop: 2 },
  markRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#FFFFFF', paddingHorizontal: 16, paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: COLORS.border },
  ...
  marksInput: { width: 64, borderWidth: 1.5, borderColor: COLORS.accent, borderRadius: 8, paddingHorizontal: 10, paddingVertical: 8, fontSize: 16, fontWeight: '600', color: COLORS.textPrimary, textAlign: 'center', marginRight: 10 },
  ...
  placeholderText: { color: COLORS.textSecondary, fontSize: 15, textAlign: 'center', marginTop: 12, lineHeight: 22 },
  saveButton: { backgroundColor: COLORS.primary, borderRadius: 8, paddingVertical: 14, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, margin: 16 },
