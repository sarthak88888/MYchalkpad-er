...
import {
  getUserSession,
  clearUserSession,
  getLanguage, //  FIXED — direct import instead of dynamic import
} from '@/lib/storage';
...
export default function SettingsScreen() {
  ...
  async function initSettings() {
    ...
    //  FIXED — direct call instead of dynamic import
        ...
        >
          ...
          <View style={styles.sectionCard}>
            ...
            {[
              ...
              { label: 'Version', value: Application.nativeApplicationVersion ?? '1.0.0' },
          ...
          <View style={styles.sectionCard}>
            ...
            <TouchableOpacity
              ...
              onPress={() => Linking.openURL('https://mychalkpad.com/privacy')}
              activeOpacity={0.8}
            >
            ...
            <TouchableOpacity
              style={styles.legalButton}
              onPress={() => Linking.openURL('https://mychalkpad.com/terms')}
              activeOpacity={0.8}
            >
              <MaterialCommunityIcons name="file-sign" size={18} color={COLORS.primary} />
...
const styles = StyleSheet.create({
  ...
  sectionCard: { backgroundColor: '#FFFFFF', borderRadius: 12, padding: 16, marginBottom: 16, elevation: 2, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.06, shadowRadius: 3 },
  sectionTitleRow: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 16, paddingBottom: 12, borderBottomWidth: 1, borderBottomColor: COLORS.border },
  ...
  saveButton: { backgroundColor: COLORS.primary, borderRadius: 8, paddingVertical: 14, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, marginBottom: 16 },
  ...
  logoutButton: { backgroundColor: COLORS.error, borderRadius: 8, paddingVertical: 14, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, marginBottom: 8 },
  logoutText: { color: '#FFFFFF', fontSize: 16, fontWeight: 'bold' },
  legalButton: { flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: COLORS.border },
  legalButtonText: { flex: 1, fontSize: 15, color: COLORS.textPrimary },
  deleteButton: { borderWidth: 1.5, borderColor: COLORS.error, borderRadius: 8, paddingVertical: 14, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, marginBottom: 8 },
