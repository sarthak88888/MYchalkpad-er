        ...
        ListHeaderComponent={
          <View style={styles.headerContent}>
            ...
            <View style={styles.sectionCard}>
              ...
              <View style={styles.channelRow}>
                {[
                  ...
                  //  FIXED — changed message-fast to message-flash (valid icon)
                  { label: 'Both', value: channelBreakdown.both, color: COLORS.accent, icon: 'message-flash' },
                ].map((c, i) => (
            ...
            <TouchableOpacity
              ...
              activeOpacity={0.8}
            >
              {/*  FIXED — changed message-fast to message-flash */}
              <MaterialCommunityIcons name="message-flash" size={20} color="#FFFFFF" />
