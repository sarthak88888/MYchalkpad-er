      ...
      <View style={styles.feeCard}>
        <View style={styles.feeCardTop}>
          <View style={styles.feeLeft}>
            ...
            {item.payment_method && <Text style={styles.feeMethod}>via {item.payment_method}</Text>}
          </View>
          <View style={styles.feeRight}>
            <Text style={[styles.feeAmount, { color: isPaid ? COLORS.success : COLORS.error }]}>₹{item.amount}</Text>
  ...
  return (
    <View style={styles.root}>
      <View style={styles.header}>
        ...
        {selectedChild && <Text style={styles.headerSub}>{selectedChild.name}</Text>}
      </View>
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={styles.emptyContainer}>
              {/* FIXED — changed cash-off to cash-remove (valid icon) */}
