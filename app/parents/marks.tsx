...
// ── Inline types (remove once @/lib/types exists) ──────────────────────────
...
export default function ParentMarksScreen() {
  ...
  async function initScreen() {
    // FIX: guard against null session (errors 18047)
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          {currentExamSummary ? (
            ...
            <View style={styles.noDataCard}>
              {/* FIX: "pencil-box-off" is invalid → replaced with "pencil-off" (errors 2820) */}
              <MaterialCommunityIcons name="pencil-off" size={36} color={COLORS.textSecondary} />
          ...
          {marks.length === 0 && !loading && (
            <View style={styles.emptyContainer}>
              {/* FIX: "pencil-box-off" is invalid → replaced with "pencil-off" (errors 2820) */}
              <MaterialCommunityIcons name="pencil-off" size={48} color={COLORS.textSecondary} />
